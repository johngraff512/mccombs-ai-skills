...
Generate a curated set of 3–5 business case ideas for MBA/EMBA instruction, delivered as a McCombs-branded Word document. This skill works across all McCombs departments — Strategy, Marketing, Finance, Operations, MIS, and Accounting. See `../shared/discipline-guide.md` for department-specific frameworks and dilemma types.
...
3. **Teachable frameworks** — the situation naturally lends itself to at least 2 frameworks in the discipline (see `../shared/discipline-guide.md` for framework lists by department)
...
```bash
node /path/to/skills/case-idea-generator/scripts/generate_ideas_docx.js <input.json> <output.docx>
```
