...
Create professional, classroom-ready business cases as McCombs-branded Word documents. This skill works across all McCombs departments — Strategy, Marketing, Finance, Operations, MIS, and Accounting. See `../shared/discipline-guide.md` for department-specific guidance on framing, frameworks, and exhibits.
