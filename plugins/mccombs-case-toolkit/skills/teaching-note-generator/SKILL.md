...
1. **The case**: Either —
   ...
   - An uploaded case document (Word .docx or PDF — the assistant will read and extract the content)
...
4. **Epilogue**: Does the instructor want to include an epilogue? If so, do they know what actually happened (or should the assistant research it)?
...
- For McCombs branding specs, see `references/docx-branding.md`
